...
const FinalCTA = () => {
  return <section className="py-24 bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 relative overflow-hidden">
              ...
              once: true
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                  ...
                  scale: 0.95
                    ...
                    <Button variant="hero" size="lg" className="text-xl px-12 py-6 hover:shadow-glow transition-all duration-300 font-semibold" onClick={() => window.location.href = '/contact'}>
                      Talk to an expert
                    </Button>
                  </motion.div>
                </div>
