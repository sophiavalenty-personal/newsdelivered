...
<body style="margin: 0; padding: 0; background-color: #f5f3ef; font-family: Georgia, Times, serif;">
  ...
  derickgant: {
    clientName: "Derick Gant - 24K Life",
    brandColor: "#C9A94E",
    newsletters: [
      {
        id: "1",
        title: "24K Life Newsletter",
        description: "Financial mindset, featured story, and gold nuggets of wisdom",
...
<body style="margin:0; padding:0; background-color:#000000;">
  ...
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color:#000000; margin:0; padding:0;">
    <tr>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" class="email-container" style="max-width:600px; width:100%;">
          ...
          <tr>
            <td style="padding:0 24px 16px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td width="24" valign="top" style="color:#C9A94E; font-family:Georgia, serif; font-size:18px; line-height:24px;">&#9670;</td>
                  <td style="padding-left:8px;">
                    <a href="https://derickgant.com/financial-coherence/" target="_blank" style="font-family:Georgia, serif; font-size:17px; color:#ffffff; text-decoration:none; font-weight:700; line-height:24px;">Why Money Problems Are NOT Income Problems</a>
                    <p style="font-family:Arial, sans-serif; font-size:14px; color:#cccccc; margin:4px 0 0; line-height:20px;">Most people believe they have a money problem. They don't. But here's the deal&hellip;</p>
                  </td>
                </tr>
              </table>
            </td>
            ...
            <td style="padding:0 24px 16px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td width="24" valign="top" style="color:#C9A94E; font-family:Georgia, serif; font-size:18px; line-height:24px;">&#9670;</td>
                  <td style="padding-left:8px;">
                    <a href="https://derickgant.com/why-never-assume-is-the-worst-advice-youve-ever-been-given/" target="_blank" style="font-family:Georgia, serif; font-size:17px; color:#ffffff; text-decoration:none; font-weight:700; line-height:24px;">Why "Never Assume" is the Worst Advice You've Ever Been Given</a>
                    <p style="font-family:Arial, sans-serif; font-size:14px; color:#cccccc; margin:4px 0 0; line-height:20px;">What if avoiding assumptions altogether has been quietly sabotaging your success? Check this out&hellip;</p>
                  </td>
                </tr>
              </table>
            </td>
            ...
            <td style="padding:0 24px 24px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td width="24" valign="top" style="color:#C9A94E; font-family:Georgia, serif; font-size:18px; line-height:24px;">&#9670;</td>
                  <td style="padding-left:8px;">
                    <a href="https://derickgant.com/shatter-your-financial-ceiling-money-secrets-revealed-to-achieve-financial-freedom/" target="_blank" style="font-family:Georgia, serif; font-size:17px; color:#ffffff; text-decoration:none; font-weight:700; line-height:24px;">Shatter Your Financial Ceiling: Money Secrets Revealed!</a>
                    <p style="font-family:Arial, sans-serif; font-size:14px; color:#cccccc; margin:4px 0 0; line-height:20px;">Dive headfirst into the epic journey of your life to achieve financial freedom. Let's review these items together&hellip;</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:0 24px 8px;" class="mobile-padding">
              <p style="font-family:Georgia, serif; font-size:13px; color:#C9A94E; text-transform:uppercase; letter-spacing:3px; margin:0 0 16px; text-align:center;">Featured Story</p>
            </td>
          </tr>
          <tr>
            <td style="padding:0 24px 24px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td style="background-color:#1a1a1a; border:1px solid #C9A94E30; border-radius:4px; padding:24px; font-family:Arial, sans-serif; font-size:15px; color:#ffffff; line-height:24px;">
                    <p style="margin:0 0 12px; font-family:Georgia, serif; font-size:19px; color:#C9A94E; font-weight:700;">The $47K Shift</p>
                    <p style="margin:0 0 12px;">Marcus was a senior project manager pulling in $92,000 a year. Good salary. Bills paid. But every month? Flat broke by the 28th. He told himself: <em>"I just need a raise."</em></p>
                    <p style="margin:0 0 12px;">Then he read something that stopped him cold: <strong>"Your income isn't the problem &mdash; your financial ceiling is."</strong> That one line changed everything. He realized he'd been operating under invisible money rules he inherited from childhood &mdash; spend what you make, save "what's left" (nothing), and pray nothing breaks.</p>
                    <p style="margin:0 0 12px;">Marcus didn't get a raise. Instead, he restructured how every dollar moved. He automated savings before spending, eliminated three subscriptions he forgot existed, and renegotiated two bills. Within 10 months, he had $47,000 in reserves &mdash; on the same salary.</p>
                    <p style="margin:0; font-weight:700; color:#C9A94E;">He didn't earn more. He just stopped letting invisible rules run his finances.</p>
                  </td>
                </tr>
              </table>
            </td>
            ...
            <td style="padding:0 24px 16px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  ...
                  <td style="padding-left:12px; font-family:Arial, sans-serif; font-size:15px; color:#cccccc; line-height:22px;">Reply to this email and let me know if there is anything you think I can help you with.</td>
                </tr>
              </table>
            </td>
          </tr>
            ...
            <td style="padding:0 24px 16px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  ...
                  <td style="padding-left:12px; font-family:Arial, sans-serif; font-size:15px; color:#cccccc; line-height:22px;">Track all expenses for 30 days, then eliminate one unnecessary recurring expense.</td>
                </tr>
              </table>
            </td>
          </tr>
            ...
            <td style="padding:0 24px 16px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  ...
                  <td style="padding-left:12px; font-family:Arial, sans-serif; font-size:15px; color:#cccccc; line-height:22px;">Pay yourself first! Always put some amount of money into your own savings account before spending or paying bills.</td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td style="padding:0 24px 16px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td width="40" valign="top" style="font-family:Georgia, serif; font-size:22px; color:#C9A94E; font-weight:700; line-height:28px;">04</td>
                  <td style="padding-left:12px; font-family:Arial, sans-serif; font-size:15px; color:#cccccc; line-height:22px;">Write down 5 non-negotiable standards for how you operate daily (money, health, discipline, mindset, relationships).</td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td style="padding:4px 24px 24px; font-family:Arial, sans-serif; font-size:15px; color:#C9A94E; font-style:italic; text-align:center;" class="mobile-padding">
              Need help putting these steps into action? <a href="https://api.leadconnectorhq.com/widget/groups/24k" style="color:#C9A94E; font-weight:700; text-decoration:underline;">Book your call now &rarr;</a>
            </td>
          </tr>
          <tr>
            <td style="padding:0 40px 24px;">
          ...
          <tr>
            <td style="padding:0 24px 24px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:2px solid #C9A94E; border-radius:8px; background-color:#1a1a1a;">
                <tr>
                ...
                <tr>
                  <td style="padding:4px 28px 20px; text-align:center; font-family:Georgia, serif; font-size:18px; font-style:italic; color:#ffffff; line-height:28px;">
                    "Your standards shape your habits; and your habits shape your results."
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:0 24px 8px;" class="mobile-padding">
              <h2 style="font-family:Georgia, serif; font-size:22px; color:#C9A94E; margin:0 0 4px; text-align:center;">Living The 24K Life</h2>
            </td>
          </tr>
          <tr>
            <td style="padding:8px 24px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td style="background-color:#1a1a1a; border:1px solid #C9A94E30; border-radius:6px; padding:16px 20px;">
                    <p style="font-family:Georgia, serif; font-size:15px; color:#cccccc; font-style:italic; line-height:22px; margin:0 0 10px;">"I finally stopped living paycheck to paycheck and built my first emergency fund in just 90 days!"</p>
                    <p style="font-family:Arial, sans-serif; font-size:13px; margin:0;">
                      <strong style="color:#C9A94E;">Nicole</strong>
                      <span style="color:#cccccc;"> &mdash; 24K Life Community Member</span>
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:8px 24px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td style="background-color:#1a1a1a; border:1px solid #C9A94E30; border-radius:6px; padding:16px 20px;">
                    <p style="font-family:Georgia, serif; font-size:15px; color:#cccccc; font-style:italic; line-height:22px; margin:0 0 10px;">"Before working with Derick, I had NO clue where my money was going. Now, I have a system, and my savings are growing every month."</p>
                    <p style="font-family:Arial, sans-serif; font-size:13px; margin:0;">
                      <strong style="color:#C9A94E;">Bryant</strong>
                      <span style="color:#cccccc;"> &mdash; Money Method Student</span>
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:8px 24px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td style="background-color:#1a1a1a; border:1px solid #C9A94E30; border-radius:6px; padding:16px 20px;">
                    <p style="font-family:Georgia, serif; font-size:15px; color:#cccccc; font-style:italic; line-height:22px; margin:0 0 10px;">"Derick didn't just give me a plan &mdash; he helped me change my mindset, my habits, and my future."</p>
                    <p style="font-family:Arial, sans-serif; font-size:13px; margin:0;">
                      <strong style="color:#C9A94E;">Emma</strong>
                      <span style="color:#cccccc;"> &mdash; High-Performance Client</span>
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center" style="background-color:#C9A94E; border-radius:6px;">
                    <a href="https://api.leadconnectorhq.com/widget/groups/24k" target="_blank" style="font-family:Georgia, serif; font-size:17px; color:#000000; text-decoration:none; font-weight:700; letter-spacing:1px; display:inline-block; padding:16px 40px; border-radius:6px; background-color:#C9A94E;">Talk 1-on-1 With Derick &rarr;</a>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td align="center" style="padding:0 24px 24px;">
              <p style="font-family:Georgia, serif; font-size:16px; color:#ffffff; margin:0 0 12px;">Was this helpful?</p>
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="padding:0 12px;"><a href="#" style="text-decoration:none; font-size:16px; color:#C9A94E; font-family:Arial, sans-serif;">Yes</a></td>
                  <td style="padding:0 12px;"><a href="#" style="text-decoration:none; font-size:16px; color:#cccccc; font-family:Arial, sans-serif;">No</a></td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding:0 24px 24px;">
              <p style="font-family:Georgia, serif; font-size:13px; color:#C9A94E; text-transform:uppercase; letter-spacing:3px; margin:0 0 16px;">Connect With Derick</p>
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="padding:0 10px;" class="social-link"><a href="https://derickgant.com" style="font-family:Arial, sans-serif; font-size:13px; color:#C9A94E; text-decoration:none; font-weight:600;">Website</a></td>
                  <td style="padding:0 10px;" class="social-link"><a href="#" style="font-family:Arial, sans-serif; font-size:13px; color:#C9A94E; text-decoration:none; font-weight:600;">LinkedIn</a></td>
                  <td style="padding:0 10px;" class="social-link"><a href="#" style="font-family:Arial, sans-serif; font-size:13px; color:#C9A94E; text-decoration:none; font-weight:600;">Instagram</a></td>
                  <td style="padding:0 10px;" class="social-link"><a href="#" style="font-family:Arial, sans-serif; font-size:13px; color:#C9A94E; text-decoration:none; font-weight:600;">X (Twitter)</a></td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td style="background-color:#1a1a1a; padding:24px; text-align:center; border-top:1px solid #C9A94E30;">
      ...
      {
        id: "2",
        title: "24K Life Newsletter - Issue 2",
        description: "Tax refunds, debt payoff success story, and actionable next steps",
        htmlContent: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
<head>
  <meta charset="utf-8" />
...
<body style="margin:0; padding:0; background-color:#000000;">
    ...
    <tr>
      <td align="center" style="padding:0 16px;">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" class="email-container" style="max-width:600px; width:100%;">
          ...
          <tr>
            <td style="padding:0 24px 24px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td style="padding-left:0;">
                    <a href="https://derickgant.com/financial-coherence/" style="font-family:Georgia, serif; font-size:17px; color:#ffffff; text-decoration:none; font-weight:700; line-height:24px;">Why Money Problems Are NOT Income Problems &rarr;</a>
                    <p style="font-family:Arial, sans-serif; font-size:14px; color:#cccccc; margin:4px 0 0; line-height:20px;">Most people believe they have a money problem. They don't. But here's the deal&hellip;</p>
                  ...
                  <td style="background-color:#1a1a1a; border:1px solid #C9A94E30; border-radius:4px; padding:24px; font-family:Arial, sans-serif; font-size:15px; color:#ffffff; line-height:24px;">
                     ...
                     <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-bottom:4px;">
                       <tr>
                         ...
                         <td style="padding-left:6px; color:#ffffff; font-family:Arial, sans-serif; font-size:15px; line-height:22px;">High Income Doesn\u2019t Equal Financial Security</td>
                       </tr>
                     </table>
                     <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-bottom:4px;">
                       <tr>
                         <td width="20" valign="top" style="color:#C9A94E; font-family:Georgia, serif; font-size:14px; line-height:22px;">&#9670;</td>
                         <td style="padding-left:6px; color:#ffffff; font-family:Arial, sans-serif; font-size:15px; line-height:22px;">Small, Consistent Changes Create Big Results</td>
                       </tr>
                     </table>
                     <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-bottom:4px;">
                       <tr>
                         <td width="20" valign="top" style="color:#C9A94E; font-family:Georgia, serif; font-size:14px; line-height:22px;">&#9670;</td>
                         <td style="padding-left:6px; color:#ffffff; font-family:Arial, sans-serif; font-size:15px; line-height:22px;">A Plan Brings Peace of Mind</td>
                       </tr>
                     </table>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:0 24px 16px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td width="40" valign="top" style="font-family:Georgia, serif; font-size:22px; color:#C9A94E; font-weight:700; line-height:28px;">01</td>
                   <td style="padding-left:12px; font-family:Arial, sans-serif; font-size:15px; color:#cccccc; line-height:22px;"><strong style="color:#ffffff;">Stop the Bleeding</strong><br/>Commit to no new credit card debt starting today. If needed, remove cards from your wallet or online accounts.</td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td style="padding:0 24px 16px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td width="40" valign="top" style="font-family:Georgia, serif; font-size:22px; color:#C9A94E; font-weight:700; line-height:28px;">02</td>
                   <td style="padding-left:12px; font-family:Arial, sans-serif; font-size:15px; color:#cccccc; line-height:22px;"><strong style="color:#ffffff;">Quick Debt Count</strong><br/>Add up your debt \u2014 write down the number. You can\u2019t fix what you haven\u2019t measured.</td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td style="padding:0 24px 16px;" class="mobile-padding">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td width="40" valign="top" style="font-family:Georgia, serif; font-size:22px; color:#C9A94E; font-weight:700; line-height:28px;">03</td>
                   <td style="padding-left:12px; font-family:Arial, sans-serif; font-size:15px; color:#cccccc; line-height:22px;"><strong style="color:#ffffff;">Redirect One Monthly Expense</strong><br/>Identify one recurring expense to reduce or eliminate. Redirect that amount toward debt payoff or savings.</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td style="background-color:#1a1a1a; padding:24px; text-align:center; border-top:1px solid #C9A94E30;">
              <p style="font-family:Georgia, serif; font-size:14px; color:#ffffff; margin:0 0 8px;">Was this helpful?</p>
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 16px;">
                <tr>
                  ...
                  <td style="padding:0 12px;"><a href="#" style="text-decoration:none; font-size:14px; color:#cccccc; font-family:Arial, sans-serif;">No</a></td>
                </tr>
              </table>
  ...
  hegland: {
    clientName: "Hegland Mainz Financial",
    brandColor: "#004712",
    newsletters: [
      {
        id: "1",
        title: "February 2026 Newsletter",
        description: "Monthly financial insights — tax tips, market updates & more",
        htmlContent: `<!DOCTYPE html>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Hegland Mainz Financial Newsletter</title>
  <style>
    @media screen and (max-width: 600px) {
...
<body style="margin:0;padding:0;background-color:#f4f4f4;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;">
  <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">
    Your monthly financial insights from Hegland Mainz Financial — tax tips, market updates & more.
  </div>
  <center style="width:100%;background-color:#f4f4f4;">
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="email-container" style="margin:0 auto;max-width:600px;">
      <tr>
        <td style="background-color:#004712;height:5px;font-size:0;line-height:0;">&nbsp;</td>
      </tr>
      <tr>
        <td style="background-color:#ffffff;padding:14px 30px 12px 30px;">
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
              <td style="text-align:left;vertical-align:middle;">
                <p style="margin:0 0 2px 0;font-size:10px;color:#d4a94f;letter-spacing:4px;text-transform:uppercase;font-weight:600;">Insights From...</p>
                <h1 style="margin:0;font-size:22px;font-weight:bold;color:#004712;letter-spacing:1px;font-family:Georgia,'Times New Roman',serif;">HEGLAND MAINZ</h1>
                <p style="margin:2px 0 0 0;font-size:9px;color:#004712;letter-spacing:3px;font-weight:400;">FINANCIAL SERVICES</p>
              </td>
              <td style="text-align:right;vertical-align:top;font-size:12px;color:#888888;padding-top:10px;">
                February 2026
              </td>
            </tr>
          </table>
      ...
      <tr>
        <td style="background-color:#ffffff;padding:0 30px;">
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
              <td style="height:2px;background-color:#d4a94f;font-size:0;line-height:0;">&nbsp;</td>
            </tr>
          </table>
        </td>
      </tr>
      <tr>
        <td style="background-color:#ffffff;padding:16px 24px 8px 24px;" class="mobile-padding">
          <p style="margin:0 0 14px 0;font-size:11px;color:#d4a94f;letter-spacing:3px;text-transform:uppercase;font-weight:700;text-align:center;">TOP READS</p>
        </td>
      </tr>
      <tr>
        <td style="background-color:#ffffff;padding:0 24px;" class="mobile-padding">
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
              <td style="padding:12px 16px;background-color:#f8faf6;border-radius:8px;border-left:3px solid #004712;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
      ...
      <tr><td style="background-color:#ffffff;height:8px;font-size:0;">&nbsp;</td></tr>
      <tr>
        <td style="background-color:#ffffff;padding:28px 24px 16px 24px;" class="mobile-padding">
          <p style="margin:0 0 16px 0;font-size:11px;color:#d4a94f;letter-spacing:3px;text-transform:uppercase;font-weight:700;text-align:center;">SPOTLIGHT ON SAVINGS</p>
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #e0e0e0;border-radius:8px;overflow:hidden;">
            <tr>
              <td style="padding:24px;background-color:#f8f9fb;">
                <h2 style="margin:0 0 16px 0;font-size:17px;color:#004712;font-weight:700;">How the Martins Saved $12K on Insurance Premiums</h2>
      ...
      <tr>
        <td style="background-color:#f8f9fb;padding:28px 24px;" class="mobile-padding">
          <p style="margin:0 0 16px 0;font-size:11px;color:#d4a94f;letter-spacing:3px;text-transform:uppercase;font-weight:700;text-align:center;">DID YOU KNOW?</p>
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
              <td style="padding:10px 14px;background-color:#ffffff;border-left:4px solid #d4a94f;">
                <p style="margin:0;font-size:14px;color:#333333;line-height:1.7;">
                  <strong style="color:#004712;">Catch-up contributions can make a big difference</strong> &mdash; If you're over 50, you can contribute extra to retirement accounts like 401(k)s and IRAs.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:10px 14px;background-color:#ffffff;border-left:4px solid #d4a94f;">
                <p style="margin:0;font-size:14px;color:#333333;line-height:1.7;">
                  <strong style="color:#004712;">Investment risk should match your timeline.</strong> Our goal is steady growth without unnecessary risk. Not being too aggressive or too conservative.
                </p>
              </td>
            </tr>
          </table>
      ...
      <tr>
        <td style="background-color:#ffffff;padding:28px 24px;" class="mobile-padding">
          <p style="margin:0 0 16px 0;font-size:11px;color:#d4a94f;letter-spacing:3px;text-transform:uppercase;font-weight:700;text-align:center;">THIS MONTH'S CHECKLIST</p>
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
              <td style="padding:14px 16px;background-color:#f0f5eb;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
                    <td width="20" style="vertical-align:top;font-size:16px;color:#004712;line-height:1.5;">&check;</td>
                    <td style="padding-left:10px;">
                      <p style="margin:0;font-size:14px;color:#333333;line-height:1.5;"><strong>Review your beneficiary designations</strong> &mdash; life changes can make old designations outdated.</p>
                    </td>
                  </tr>
                </table>
              </td>
              ...
              <td style="padding:14px 16px;background-color:#f0f5eb;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
                    <td width="20" style="vertical-align:top;font-size:16px;color:#004712;line-height:1.5;">&check;</td>
                    <td style="padding-left:10px;">
                      <p style="margin:0;font-size:14px;color:#333333;line-height:1.5;"><strong>Schedule your annual policy review</strong> &mdash; ensure coverage matches your goals and family situation.</p>
                    </td>
                  </tr>
                </table>
              </td>
              ...
              <td style="padding:14px 16px;background-color:#f0f5eb;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
                    <td width="20" style="vertical-align:top;font-size:16px;color:#004712;line-height:1.5;">&check;</td>
                    <td style="padding-left:10px;">
                      <p style="margin:0;font-size:14px;color:#333333;line-height:1.5;"><strong>Max out your retirement contributions</strong> &mdash; if you haven't hit the 2026 limit, now's the time.</p>
                    </td>
                  </tr>
                </table>
              </td>
      ...
      <tr>
        <td style="background-color:#004712;padding:32px 30px;text-align:center;">
          <h2 style="margin:0 0 8px 0;font-size:20px;color:#ffffff;font-weight:700;">Get Your Free Financial Roadmap</h2>
          <p style="margin:0 0 20px 0;font-size:14px;color:#b8dfc4;line-height:1.6;">Personalized guidance for your retirement, taxes, and insurance &mdash; no obligation.</p>
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
            <tr>
              <td style="background-color:#d4a94f;border-radius:8px;">
                <a href="https://www.heglandmainz.com/contact" target="_blank" style="display:inline-block;padding:14px 40px;color:#ffffff;font-size:16px;font-weight:700;text-decoration:none;font-family:Arial,sans-serif;">Book a Call &gt;&gt;</a>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td style="background-color:#ffffff;padding:28px 30px;text-align:center;" class="mobile-padding">
      ...
      <tr>
        <td style="background-color:#f8f9fb;padding:20px 30px;text-align:center;">
          <p style="margin:0 0 10px 0;font-size:14px;color:#555555;">Was this newsletter helpful?</p>
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
            <tr>
              <td style="padding:0 6px;">
                <span style="display:inline-block;padding:8px 20px;border-radius:50px;background-color:#e8f5e9;font-size:14px;">Yes</span>
              </td>
              <td style="padding:0 6px;">
                <span style="display:inline-block;padding:8px 20px;border-radius:50px;background-color:#fce4ec;font-size:14px;">No</span>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td style="background-color:#004712;padding:24px 30px;text-align:center;">
          ...
          <p style="margin:0;font-size:11px;">
            <span style="color:#b8dfc4;text-decoration:underline;">Unsubscribe</span> &nbsp;|&nbsp;
            <span style="color:#b8dfc4;text-decoration:underline;">Manage Preferences</span>
          </p>
        </td>
      </tr>
    </table>
