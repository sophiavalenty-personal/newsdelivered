            ...
            <div className="max-w-6xl mx-auto">
              ...
              <ScrollReveal direction="up" delay={0.1}>
                <div className="text-center mb-16">
                  ...
                  duration: 0.6,
                  delay: 0.2
                }} className="text-xl text-muted-foreground max-w-2xl mx-auto">Need content fast? Use our expertly curated content channels designed to engage and convert your specific audience.</motion.p>
                </div>
              </ScrollReveal>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                ...
                return <ScrollReveal key={channel.title} direction="up" delay={index * 0.1}>
                    ...
                    ease: "easeOut"
                        ...
                        <Card className="group h-full bg-white/80 backdrop-blur-sm border-0 shadow-subtle hover:shadow-elegant transition-all duration-500 overflow-hidden cursor-pointer" onClick={() => navigate(`/channels/${channel.id}`)}>
              ...
              <ScrollReveal direction="up" delay={0.6}>
                <div className="text-center bg-white/60 backdrop-blur-sm rounded-2xl p-12 shadow-subtle">
                  ...
                  duration: 0.2
                    ...
                    <Button variant="hero" size="lg" className="text-lg px-8 py-6 shadow-subtle hover:shadow-elegant transition-all duration-400" onClick={() => window.location.href = '/contact'}>
                      Talk to an Expert
                    </Button>
                  </motion.div>
                </div>
