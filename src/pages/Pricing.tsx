                ...
                <thead>
                  <tr className="border-b-2 border-primary/20">
                    ...
                    <th className="py-3 px-4 text-sm font-semibold text-center text-foreground">
                      Start
                      <div className="text-xs font-normal text-muted-foreground mt-1">Up to 4 Newsletters<br />per month</div>
                    </th>
                    <th className="py-3 px-4 text-sm font-semibold text-center text-foreground">
                      Grow
                      <div className="text-xs font-normal text-muted-foreground mt-1">Up to 8 Newsletters<br />per month</div>
                    </th>
                    <th className="py-3 px-4 text-sm font-semibold text-center text-foreground">
                      Scale
                      <div className="text-xs font-normal text-muted-foreground mt-1">Up to 10+ Newsletters<br />per month</div>
                    </th>
                  </tr>
                </thead>
                <tbody>
